...
export const PromoCodePage: React.FC<{ data: AppState; onUpdateData?: (data: AppState) => void }> = ({ data, onUpdateData }) => {
 ...
 className="bg-slate-900 text-white px-6 py-3 rounded-2xl font-bold flex items-center gap-2 hover:scale-105 active:scale-[0.98] transition-all duration-200 transition-all shadow-[0_2px_10px_rgb(0,0,0,0.04)] shadow-slate-900/20"
 >
 ...
 <div className="text-right">
 <div className="text-2xl font-black text-slate-900">{stats.totalSavings.toFixed(3)} د.ك</div>
 <div className="text-xs font-bold text-slate-500">خصومات ممنوحة</div>
 </div>
 </div>
 </div>

 <div className="bg-gradient-to-br from-amber-500 to-amber-600 rounded-2xl p-4 md:p-5 lg:p-6 text-white shadow-[0_4px_20px_rgb(0,0,0,0.05)] relative overflow-hidden">
 <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -translate-y-1/2 translate-x-1/2" />
 <div className="relative z-10 flex flex-col md:flex-row items-center gap-4 md:p-5">
 <div className="w-12 h-12 md:w-16 md:h-16 bg-white/20 backdrop-blur-md rounded-2xl flex items-center justify-center shrink-0 shadow-[0_2px_10px_rgb(0,0,0,0.04)]">
 <Award size={32} />
 </div>
 ...
 <div className="bg-white/10 backdrop-blur-md p-3 rounded-xl md:rounded-2xl border border-white/20 whitespace-nowrap text-center">
 <div className="text-[11px] sm:text-xs opacity-80 font-bold mb-1">إجمالي نقاط النظام</div>
 ...
 <div className="p-3 md:p-4 border-b border-slate-200/60 bg-slate-50/50">
 <h3 className="font-black text-lg text-slate-900">سجل الكوبونات</h3>
 </div>
 ...
 <span className="font-black text-slate-900 text-lg uppercase tracking-wider">{c.code}</span>
 <span className="text-[11px] sm:text-xs text-slate-500 font-bold">{c.description || 'بدون وصف'}</span>
 </div>
 </td>
 ...
 className={cn(
"inline-flex items-center gap-1 px-3 py-1 rounded-full text-[11px] sm:text-xs font-black transition-all hover:scale-105 active:scale-[0.98] transition-all duration-200",
 ...
 className="text-slate-300 hover:text-rose-500 transition-colors p-2 rounded-xl group-hover:bg-rose-50 active:scale-90 min-w-[44px] min-h-[44px] flex items-center justify-center shrink-0"
 >
 <Trash2 size={18} />
 </button>
 </td>
 ...
 <tr>
 <td colSpan={5} className="p-3 md:p-4 md:p-5 md:p-4 text-center">
 ...
 className="relative bg-white w-full max-w-lg rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] overflow-hidden"
 dir="rtl"
 >
 <div className="bg-slate-900 p-4 md:p-5 lg:p-6 text-white relative text-right">
 ...
 <div className="p-4 md:p-5 lg:p-6 space-y-6 text-right">
 <div>
 ...
 className="w-full bg-slate-50/50 border border-slate-200/60 p-3 rounded-2xl font-bold text-slate-900 focus:ring-2 focus:ring-slate-900 outline-none transition-all placeholder:text-slate-300 text-right"
 />
 </div>
 ...
 className="w-full bg-slate-50/50 border border-slate-200/60 p-3 rounded-2xl font-bold text-slate-900 focus:ring-2 focus:ring-slate-900 outline-none transition-all text-right"
 >
 ...
 className="w-full bg-slate-50/50 border border-slate-200/60 p-3 rounded-2xl font-bold text-slate-700 focus:ring-2 focus:ring-slate-900 outline-none transition-all placeholder:text-slate-300 min-h-[100px] text-right"
 />
 </div>
 ...
 className="w-full bg-slate-900 text-white py-5 rounded-2xl font-black text-lg hover:bg-slate-800 active:scale-[0.98] transition-all shadow-[0_4px_20px_rgb(0,0,0,0.05)] shadow-slate-900/20"
 >
 إطلاق الكود وتعميمه 🚀
 </button>
 </div>
