...
export const WhatIfSimulator: React.FC<WhatIfSimulatorProps> = ({ data, onUpdateData }) => {
 ...
 <h2 className="text-2xl md:text-xl md:text-2xl font-bold text-white mb-4 md:mb-6 relative z-10 flex items-center gap-4 text-right px-4">
...
"p-3 rounded-2xl border text-right font-bold text-sm flex items-center justify-between transition-all active:scale-95 min-h-[44px]",
 ...
 className={cn(
"p-3 rounded-2xl border text-right font-bold text-sm flex items-center justify-between transition-all active:scale-95 min-h-[44px]",
 scenarioType === 'promotion' ? 'bg-indigo-600 text-white border-indigo-500 shadow-lg' : 'bg-slate-900/50 text-slate-500 border-slate-800 hover:border-indigo-500/50 hover:bg-slate-800/80'
)}
 >
...
"text-xs md:text-sm font-bold px-4 py-2 rounded-2xl border transition-all duration-500",
 ...
 <span className={cn(
"text-xl md:text-3xl md:text-xl md:text-2xl font-bold transition-colors duration-500",
 ...
 <div className="absolute inset-x-0 h-4 bg-slate-100 rounded-full overflow-hidden border border-slate-200/60/50">
 <div 
 className={cn(
...
"p-3 rounded-2xl border transition-all duration-500",
 ...
 className="w-full p-3 rounded-2xl bg-slate-50 border border-slate-200/60 font-bold text-base md:text-lg text-slate-800 outline-none focus:ring-2 focus:ring-indigo-500 min-h-[44px]"
 />
 </div>
)}
...
"rounded-2xl p-3 md:p-4 text-right shadow-sm border group relative overflow-hidden transition-all",
 ...
 disabled={isExecuting}
 className={cn(
"w-full md:w-auto px-4 md:px-8 md:px-12 py-3 md:py-4 rounded-xl md:rounded-2xl font-bold text-sm md:text-base border shadow-xl flex items-center justify-center gap-3 transition-all active:scale-95 disabled:opacity-50 min-h-[44px]",
 isPositive 
