      ...
      {studioTab === 'reel' && (
        <div className="studio-workbench-grid grid xl:grid-cols-[420px_minmax(0,1fr)] gap-4 sm:gap-6 items-start">
          ...
          <div className="studio-preview-card rounded-[24px] bg-slate-50 p-3 sm:p-5 shadow-[inset_0_2px_4px_rgba(0,0,0,0.02)] border border-slate-200 min-h-[460px] sm:min-h-[640px] flex items-center justify-center relative overflow-hidden studio-preview-stage">
            ...
            {!generatedReel && !isGeneratingReel && <div className="relative z-10 text-center p-6 sm:p-8 rounded-[26px] bg-slate-950/55 border border-white/10 shadow-[0_18px_60px_rgba(15,23,42,0.22)] backdrop-blur-sm"><div className="mx-auto mb-6 flex h-24 w-24 items-center justify-center rounded-[20px] bg-white border border-slate-200 shadow-sm transition-transform"><Film className="w-10 h-10 text-slate-300" strokeWidth={1.5}/></div><h3 className="text-2xl sm:text-3xl font-black mb-3 font-display text-white drop-shadow-sm">معاينة الريل من الكاميرا</h3><p className="text-xs sm:text-sm font-black text-slate-100/90 leading-7 font-mono uppercase tracking-wider">{activeStudioScene.label} · إطار 9:16 · ريل عمودي · {reelDuration} ثواني</p></div>}
