...
const CommandBar: React.FC<CommandBarProps> = ({ isOpen, onClose, onNavigate, data, userRole }) => {
  ...
  const commands = useMemo<CommandItem[]>(() => {
    const allTabs: CommandItem[] = [
      ...
      { id: 'dashboard-ai', label: 'مختبر الذكاء', hint: 'تحليلات واستقرار', icon: <Sparkles />, category: 'الرئيسية', action: () => onNavigate('dashboard', { exactId: 'intelligence' }), roles: ['admin'] },
      { id: 'dashboard-growth', label: 'محاكي النمو والتسويق', hint: 'تجارب وحملات', icon: <Target />, category: 'الرئيسية', action: () => onNavigate('dashboard', { exactId: 'growth' }), roles: ['admin'] },
      { id: 'dashboard-customers', label: 'العملاء والولاء', hint: 'نبض العملاء', icon: <Users />, category: 'الرئيسية', action: () => onNavigate('dashboard', { exactId: 'customers' }), roles: ['admin'] },
      { id: 'dashboard-suppliers', label: 'الموردين والمخاطر', hint: 'توريد ومراجعة', icon: <Truck />, category: 'الرئيسية', action: () => onNavigate('dashboard', { exactId: 'suppliers' }), roles: ['admin'] },
      { id: 'dashboard-financials', label: 'المالية وحماية الأرباح', hint: 'الأرقام المهمة', icon: <DollarSign />, category: 'الرئيسية', action: () => onNavigate('dashboard', { exactId: 'financials' }), roles: ['admin'] },
      { id: 'dashboard-loyalty', label: 'الولاء', hint: 'النقاط والمكافآت', icon: <TrendingUp />, category: 'الولاء والكوبونات', action: () => onNavigate('dashboard', { exactId: 'loyalty' }), roles: ['admin'] },
      { id: 'dashboard-promocodes', label: 'الكوبونات', hint: 'إدارة الخصومات', icon: <Sparkles />, category: 'الولاء والكوبونات', action: () => onNavigate('dashboard', { exactId: 'promocodes' }), roles: ['admin'] },
      { id: 'dashboard-diwaniya', label: 'بطولات الديوانية', hint: 'المجتمع والترتيب', icon: <Users />, category: 'الولاء والكوبونات', action: () => onNavigate('dashboard', { exactId: 'diwaniya' }), roles: ['admin'] },
