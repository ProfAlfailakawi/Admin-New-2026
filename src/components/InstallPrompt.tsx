      ...
      {showPrompt && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 md:bottom-6 md:left-auto md:right-8 md:w-[420px] z-[100] bg-white rounded-t-[32px] md:rounded-[32px] p-6 shadow-[0_-10px_40px_rgba(0,0,0,0.1)] md:shadow-[0_20px_50px_rgba(0,0,0,0.15)] border-t md:border border-slate-100"
            dir="rtl"
          >
            ...
            <div className="flex items-start gap-4 mb-8">
              <div className="flex-shrink-0 w-[72px] h-[72px] bg-black rounded-[20px] flex items-center justify-center text-white shadow-xl">
                <span className="text-4xl font-black mb-1">ت</span>
              </div>
              <div className="flex-1 mt-1.5">
                <h3 className="text-[22px] font-black text-slate-900 mb-1.5 tracking-tight">ثبّت تطبيق التراث</h3>
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="flex-1 bg-black hover:bg-slate-900 text-white flex items-center justify-center gap-2 py-4 rounded-[20px] font-black text-base shadow-lg shadow-black/10 active:scale-95 transition-all duration-300"
              >
