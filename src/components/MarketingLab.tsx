...
export const MarketingLab: React.FC<MarketingLabProps> = ({ data }) => {
 ...
 <h3 className="font-bold text-lg md:text-xl text-slate-800 mb-4 md:mb-6 text-right flex items-center justify-end gap-3">
 ...
 <h4 className="text-xl md:text-2xl font-bold text-indigo-700 mb-3 md:mb-4">{activeCampaign.idea}</h4>
 ...
 <span className="text-xs md:text-sm font-bold text-slate-800">الجمهور المستهدف</span>
 ...
 <div className="bg-white p-3 md:p-4 md:p-3 rounded-2xl border border-[#f0e6d2] shadow-sm text-right">
 <div className="flex items-center justify-end gap-3 mb-3 md:mb-4">
 <span className="text-xs md:text-sm font-bold text-slate-800">التوقيت المقترح</span>
 ...
 <div className="bg-white p-3 md:p-4 md:p-3 rounded-2xl border border-[#f0e6d2] shadow-sm text-right">
 <div className="flex items-center justify-end gap-3 mb-3 md:mb-4">
 <span className="text-xs md:text-sm font-bold text-slate-800">النتيجة المتوقعة</span>
 ...
 <h3 className="font-bold text-xl md:text-3xl text-slate-800">لوحة التنفيذ الذكي</h3>
 <span className="px-3 py-1 bg-emerald-50 text-emerald-600 rounded-full text-[10px] md:text-xs font-bold border border-emerald-100 uppercase">جاهزة للإطلاق</span>
 </div>
...
" {activeCampaign.marketingMessage}"
 ...
 <h5 className="text-[10px] md:text-xs font-bold text-slate-500 uppercase tracking-tighter">قنوات التوزيع المحددة</h5>
