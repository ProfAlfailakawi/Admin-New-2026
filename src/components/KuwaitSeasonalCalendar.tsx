...
export const KuwaitSeasonalCalendar: React.FC<{ data: AppState }> = ({ data }) => {
 ...
 <span className="text-[10px] md:text-[11px] font-bold text-indigo-700 uppercase">تتبع ذكي للمواسم مفعل</span>
 </div>
 </div>
 ...
 <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl md:rounded-2xl flex items-center justify-center border bg-white/20 border-white/10">
 <Calendar size={20} className="text-white" />
 </div>
 <span className="bg-emerald-400 text-emerald-950 font-bold text-[10px] md:text-[11px] px-2 py-0.5 rounded-full uppercase">الموسم الحالي</span>
 </div>
 
 <h4 className="text-lg md:text-xl font-bold mb-2 text-right">{event.nameAr}</h4>
 ...
 <h5 className="text-[10px] md:text-[11px] font-bold mb-2 text-right uppercase tracking-wider text-indigo-200">الفرصة التسويقية</h5>
 ...
 <h5 className="text-[10px] md:text-[11px] font-bold text-right uppercase text-indigo-200">أكثر المبيعات المتوقعة</h5>
 <div className="flex flex-wrap gap-2 justify-end">
 {event.suggestedProductsAr.map(p => (
 <span key={p} className="px-2 md:px-3 py-1 rounded-lg text-[10px] md:text-[11px] font-bold border bg-white/10 border-white/10 text-white">
 {p}
 </span>
))}
 </div>
 ...
 <span className="bg-amber-100 text-amber-700 font-bold text-[10px] md:text-[11px] px-2 py-0.5 rounded-full uppercase">قريباً</span>
 </div>
 ...
 <h5 className="text-[10px] md:text-[11px] font-bold mb-2 text-right uppercase tracking-wider text-slate-500">الاستعداد التشغيلي</h5>
 ...
 <div className="mt-auto">
 <div className="space-y-3">
 <h5 className="text-[10px] md:text-[11px] font-bold text-right uppercase text-slate-500">المخزون المقترح</h5>
 <div className="flex flex-wrap gap-2 justify-end">
 {event.suggestedProductsAr.map(p => (
 <span key={p} className="px-2 md:px-3 py-1 rounded-lg text-[10px] md:text-[11px] font-bold border bg-white border-slate-100 text-slate-600">
 {p}
 </span>
))}
 </div>
