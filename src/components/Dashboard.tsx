                                ...
                                <div className="flex gap-2">
                                  {v.totalSpent > 100 ? (
                                    <button
                                      onClick={() => {
                                        const messages = [
                                          `هلا ${v.name}، أنت من عملائنا المميزين.

جهزنا لك مكافأة خاصة تقديراً لولائك.
Alturath.kw`,
                                          `حياك الله ${v.name}، يسعدنا نهديك خصم خاص لطلبك القادم.

Alturath.kw`,
                                          `عزيزنا ${v.name}، نورتنا دائماً. عندك هدية بسيطة بانتظارك.

Alturath.kw`,
                                          `هلا ${v.name}، جهزنا لك عرض حصري من مطبخ التراث الكويتي.
...
Alturath.kw`,
                                    ...
                                    <button
                                      onClick={() => {
                                        const messages = [
                                          `هلا ${v.name}، اشتقنا لطلباتك. عندك خصم RETURN15 لطلبك القادم.

Alturath.kw`,
                                          `حياك الله ${v.name}، ننتظر رجعتك وخصمك جاهز.

Alturath.kw`,
                                          `عزيزنا ${v.name}، لك خصم خاص عند طلبك القادم.

Alturath.kw`,
                                          `مرحباً ${v.name}، مطبخ التراث الكويتي يرحب بعودتك. استخدم كود WELCOMEBACK.
