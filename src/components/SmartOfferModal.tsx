...
"bg-rose-50/50 border-rose-100"
 ...
 <button onClick={onClose} className="w-full bg-slate-50 border border-slate-200 text-slate-900 hover:bg-slate-100 text-white py-3.5 rounded-2xl font-bold shadow-xl active:scale-95 transition-all text-base leading-none">
 فهمت، شكراً
 </button>
 </div>
 </motion.div>
