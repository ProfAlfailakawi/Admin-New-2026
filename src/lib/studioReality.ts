...
- The image must feel photographed by a real human in Kuwait for a real home order, delivery, diwaniya, chalet, farm, jakhour, or family gathering; not generated by AI.
- Use believable Kuwaiti order elements only: home table, diwaniya table, chalet serving surface, delivery packaging, kitchen prep counter, simple napkin, water cup, neutral wall, soft bokeh, and practical human surfaces.
...
export const STUDIO_REALITY_MODES: Record<StudioRealityMode, { label: string; prompt: string }> = {
  ...
  finalBoss: {
    ...
    prompt: 'Style: ultra-believable human Kuwaiti order photography. The scene must pass as a real photo taken for a home, diwaniya, chalet, farm, jakhour, zowara, or delivery: imperfect handheld framing, real lens softness, grounded scale, believable shadows, ordinary surfaces, no AI polish, no fantasy styling.'
  }
};
...
Evaluate whether the image looks like a human Kuwaiti order/gathering photo. Check: believable background, correct dish preservation, natural shadows, realistic scale, lens behavior, no AI/fantasy decor, no text/logos inside image, no forbidden heritage props.
