...
setPaymentLink(createdLink);
 ...
 <div className="bg-white rounded-3xl lg:rounded-[2rem] p-4 md:p-5 lg:p-6 shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-slate-200 sticky top-24">
 ...
 <p className="text-[11px] sm:text-xs text-slate-500 font-bold uppercase">{cartItems.length} وجبات مختارة</p>
 </div>
 </div>
 ...
 readOnly={isPaid}
 className={cn(
"w-full bg-slate-50/50 border border-slate-200/60 rounded-2xl py-4 px-5 outline-none focus:ring-4 focus:ring-primary/5 focus:border-primary transition-all font-black text-slate-900 text-right",
 ...
 className={cn(
"w-full bg-slate-50/50 border border-slate-200/60 rounded-2xl py-4 pr-11 pl-5 outline-none focus:ring-4 focus:ring-primary/5 focus:border-primary transition-all font-black text-slate-900 text-right",
 isPaid &&"opacity-60 cursor-not-allowed"
)}
 />
...
"bg-amber-100"
 ...
 <div className="flex justify-between items-center p-4 md:p-5 lg:p-6 bg-primary/5 rounded-xl md:rounded-2xl border border-primary/10">
 <div>
