...
const CustomerPage: React.FC<CustomerPageProps> = React.memo(({ data, setData, deepLinkData, onClearDeepLink }) => {
 ...
 <div className="flex overflow-x-auto custom-scrollbar bg-slate-100 p-1.5 rounded-2xl gap-1 border border-slate-200 w-full sm:w-auto min-w-[44px] min-h-[44px] flex items-center justify-center shrink-0">
 {[
