...
const GlobalStatBox = React.memo(({ label, value, color, icon: Icon, isPercent = false, subtext = '', unit = '' }: any) => {
 ...
 className={cn(
"p-4 md:p-5 lg:p-6 lg:p-4 md:p-5 lg:p-6 rounded-xl md:rounded-2xl border bg-white relative overflow-hidden group shadow-sm hover:shadow-[0_4px_20px_rgb(0,0,0,0.05)] transition-all duration-300 cursor-pointer active:scale-[0.98] transition-all duration-200",
 getGradient(color)
)}
 >
...
const PartnerDashboard: React.FC<PartnerDashboardProps> = ({ data, onNavigate, onLogout }) => {
 ...
 return (
 <div className="min-h-full bg-slate-50 p-4 md:p-5 lg:p-6 lg:p-3 md:p-4 animate-in fade-in duration-500 transition-colors" dir="rtl">
