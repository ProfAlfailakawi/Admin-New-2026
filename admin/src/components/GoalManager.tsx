...
export const GoalManager: React.FC<GoalManagerProps> = ({ data, onUpdateData }) => {
 ...
 <div className="flex flex-col md:flex-row justify-between items-center bg-slate-950 p-3 md:p-4 md:p-5 rounded-2xl md:rounded-xl md:rounded-2xl border border-indigo-500/20 shadow-[0_8px_30px_rgb(0,0,0,0.08)] flex-row-reverse gap-4 relative overflow-hidden">
 ...
 <p className="text-indigo-400 text-[11px] sm:text-xs md:text-xs font-bold mt-1">AI Goal Commander 🚀</p>
 </div>
 ...
 <span className="text-[9px] md:text-[11px] sm:text-xs font-bold text-indigo-300 uppercase">تتبع الأهداف مفعّل</span>
 </div>
 </div>

 <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-3 md:p-4">
 {/* Create / Active Goal */}
 <div className="bg-slate-900 border border-slate-800 p-3 md:p-4 md:p-5 rounded-2xl md:rounded-2xl text-white relative overflow-hidden group shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
 ...
 <span className="text-[11px] sm:text-xs md:text-xs font-bold text-indigo-400 uppercase block mb-1">الهدف الحالي المفعّل</span>
 ...
 <button 
 onClick={clearGoal}
 className="w-full py-4 rounded-xl md:rounded-2xl bg-slate-800 hover:bg-slate-700 border border-slate-700 text-slate-300 hover:text-white text-[11px] sm:text-xs md:text-xs font-bold transition-all min-h-[44px]"
 >
 ...
 <div className="bg-slate-950/50 p-3 md:p-4 md:p-5 rounded-2xl md:rounded-xl md:rounded-2xl border border-indigo-500/20 relative overflow-hidden">
 ...
 className="bg-slate-900/80 backdrop-blur-xl p-3 md:p-4 rounded-xl md:rounded-2xl border border-slate-800 hover:border-indigo-500/50 transition-all cursor-pointer group flex flex-row-reverse items-center justify-between gap-4 shadow-[0_4px_20px_rgb(0,0,0,0.05)]"
 ...
 <p className="text-[11px] sm:text-xs md:text-xs font-bold text-slate-500 mt-1">{rec.reason}</p>
 </div>
 </div>
